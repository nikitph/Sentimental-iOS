...
import fumicust from '../../App/Components/fumicust'

const wrapper = shallow(<fumicust />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('fumicust Component')) // That the Component Text is included
})
